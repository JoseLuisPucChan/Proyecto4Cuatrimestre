<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/PaginaPrincipal.Master" AutoEventWireup="true" CodeBehind="VistaEquipo.aspx.cs" Inherits="MCTuristic_Centro_Historico.GUI.VistaEquipo" %>
...
<div class="row">
<div class="col-lg-12">
<div class="main_content_slider_wrapper" style="max-width: 1078px; width: 1078px;">
...
<div class="circle_slider_text_wrapper" id="sw1" style="width: 1056px; top: 0px; left: 0px; display: inline-block;">
...
<div class="circle_slider_text_wrapper" id="sw2" style="display: none; width: 1056px; top: 0px; left: 0px;">
...
<div class="circle_slider_text_wrapper" id="sw3" style="width: 1056px; top: 0px; left: 0px; display: none;">
...
<div class="circle_slider_text_wrapper" id="sw4" style="width: 1056px; top: 0px; left: 0px; display: none;">
...
<div class="circle_slider_text_wrapper" id="sw5" style="width: 1056px; top: 0px; left: 0px; display: none;">
...
<div class="circle_slider_text_wrapper" id="sw6" style="display: none; width: 1056px; top: 0px; left: 0px;">
...
<h3>Our Partners</h3>
<div class="bx-wrapper" style="max-width: 1140px;"><div class="bx-viewport" style="width: 100%; overflow: hidden; position: relative; height: 101px;"><ul class="logo-slider" style="width: 1015%; position: relative; transition-duration: 0s; transform: translate3d(-1164px, 0px, 0px);"><li style="float: left; list-style: none; position: relative; width: 170px; margin-right: 24px;" class="bx-clone"><img src="images/pl-03.png"></li><li style="float: left; list-style: none; position: relative; width: 170px; margin-right: 24px;" class="bx-clone"><img src="images/pl-04.png"></li><li style="float: left; list-style: none; position: relative; width: 170px; margin-right: 24px;" class="bx-clone"><img src="images/pl-05.png"></li><li style="float: left; list-style: none; position: relative; width: 170px; margin-right: 24px;" class="bx-clone"><img src="images/pl-06.png"></li><li style="float: left; list-style: none; position: relative; width: 170px; margin-right: 24px;" class="bx-clone"><img src="images/pl-01.png"></li><li style="float: left; list-style: none; position: relative; width: 170px; margin-right: 24px;" class="bx-clone"><img src="images/pl-02.png"></li>
<li style="float: left; list-style: none; position: relative; width: 170px; margin-right: 24px;"><img src="images/pl-01.png"></li>
<li style="float: left; list-style: none; position: relative; width: 170px; margin-right: 24px;"><img src="images/pl-02.png"></li>
<li style="float: left; list-style: none; position: relative; width: 170px; margin-right: 24px;"><img src="images/pl-03.png"></li>
<li style="float: left; list-style: none; position: relative; width: 170px; margin-right: 24px;"><img src="images/pl-04.png"></li>
<li style="float: left; list-style: none; position: relative; width: 170px; margin-right: 24px;"><img src="images/pl-05.png"></li>
<li style="float: left; list-style: none; position: relative; width: 170px; margin-right: 24px;"><img src="images/pl-06.png"></li>
<li style="float: left; list-style: none; position: relative; width: 170px; margin-right: 24px;"><img src="images/pl-01.png"></li>
<li style="float: left; list-style: none; position: relative; width: 170px; margin-right: 24px;"><img src="images/pl-02.png"></li>
<li style="float: left; list-style: none; position: relative; width: 170px; margin-right: 24px;" class="bx-clone"><img src="images/pl-01.png"></li><li style="float: left; list-style: none; position: relative; width: 170px; margin-right: 24px;" class="bx-clone"><img src="images/pl-02.png"></li><li style="float: left; list-style: none; position: relative; width: 170px; margin-right: 24px;" class="bx-clone"><img src="images/pl-03.png"></li><li style="float: left; list-style: none; position: relative; width: 170px; margin-right: 24px;" class="bx-clone"><img src="images/pl-04.png"></li><li style="float: left; list-style: none; position: relative; width: 170px; margin-right: 24px;" class="bx-clone"><img src="images/pl-05.png"></li><li style="float: left; list-style: none; position: relative; width: 170px; margin-right: 24px;" class="bx-clone"><img src="images/pl-06.png"></li></ul></div><div class="bx-controls bx-has-pager bx-has-controls-direction"><div class="bx-pager bx-default-pager"><div class="bx-pager-item"><a href="" data-slide-index="0" class="bx-pager-link active">1</a></div><div class="bx-pager-item"><a href="" data-slide-index="1" class="bx-pager-link">2</a></div></div><div class="bx-controls-direction"><a class="bx-prev" href="">Prev</a><a class="bx-next" href="">Next</a></div></div></div>
</div>
</div>
</div>
</div>
